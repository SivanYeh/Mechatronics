...
void APP_Tasks(void) {
    ...
    switch (appData.state) {
        ...
        case APP_STATE_MOUSE_EMULATE:
            ...
            //d = (accelX-(-17000))/34000.0*180/90.0;
            d = (accelX)/17000.0*180/45.0;
            indexX=d;

            //d2= (accelY-(-17000))/34000.0*180/90.0;
            d2= (accelY)/17000.0*180/45.0;
            indexY=d2;
            ...
            if (inc==10){
                appData.xCoordinate = (int8_t)indexX*5;
                appData.yCoordinate = (int8_t)indexY*5;
                inc=0;
