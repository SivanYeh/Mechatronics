...
void APP_Tasks(void) {
    ...
    switch (appData.state) {
        ...
        case APP_STATE_SCHEDULE_WRITE:
            ...
            //OC1RS = 1000; //duty cycle*(PR+1)) left/ /TMR5
            //OC4RS = 1000;
            OC1RS = 500; //duty cycle*(PR+1)) left/ /TMR5
            OC4RS = 500; 
            
           
            //float v5=TMR5/700.0*50;
            //float v3=TMR3/700.0*50;
            
            //len = sprintf(dataOut, "external count: %d, %d \n", TMR5, TMR3);
